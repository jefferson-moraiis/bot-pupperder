...
const login = async (req, res) => {
  ...
  const x = Object.keys(users).map(function (user) {
    return users[user];
  });
  ...
  for (var i = 0; i < users.length; i++) {
    if (i === 0) {
      loginUser1(x[0].email, link);
    } else if (i === 1) {
      setTimeout(function () {
        loginUser2(x[1].email, link);
      }, 5000000);
    } else if (i === 2) {
      setTimeout(function () {
        loginUser3(x[2].email, link);
      }, 240000);
    } else if (i === 3) {
      setTimeout(function () {
        loginUser4(x[3].email, link);
      }, 360000);
    } else if (i === 4) {
      setTimeout(function () {
        loginUser5(x[4].email, link);
      }, 480000);
    } else if (i === 5) {
      setTimeout(function () {
        loginUser6(x[5].email, link);
      }, 600000);
    } else if (i === 6) {
      setTimeout(function () {
        loginUser7(x[6].email, link);
      }, 720000);
    } else if (i === 7) {
      setTimeout(function () {
        loginUser8(x[7].email, link);
      }, 840000);
    } else if (i === 8) {
      setTimeout(function () {
        loginUser9(x[8].email, link);
      }, 960000);
    } else if (i === 9) {
      setTimeout(function () {
        loginUser10(x[9].email, link);
      }, 100000);
    }
  }
